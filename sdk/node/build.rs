//! Build script for the smol SDK native core (formerly smolvm-napi).
//!
...
fn link_libkrun() {
    ...
    #[cfg(target_os = "linux")]
    {
        ...
        // Look in the smolvm root. This crate now lives at
        // <smolvm-root>/smol/sdk/node, so the root is THREE levels up.
